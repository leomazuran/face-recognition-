# this program will use a webcam, detect a face using Haar Cascade and let the user save crop image of the person's face and save it on a local documnet folder
